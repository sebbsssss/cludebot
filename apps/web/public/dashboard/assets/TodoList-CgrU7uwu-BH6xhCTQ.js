import{ar as o,am as t,b8 as n}from"./index-C5ltmIwg.js";import{c as a}from"./createLucideIcon-bRcOMvfd.js";import{C as c}from"./check-D-N_CMlD.js";const l=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],d=a("x",l),h=o.div`
  display: flex;
...
`;const m=({children:i,variant:r="default",icon:e})=>{let s=()=>{switch(r){case"success":return"var(--privy-color-icon-success)";case"error":return"var(--privy-color-icon-error)";default:return"var(--privy-color-icon-muted)"}};return t.jsxs(u,{children:[t.jsx(p,{$variant:r,"data-variant":r,children:(()=>{if(e)return n.isValidElement(e)?n.cloneElement(e,{stroke:s(),strokeWidth:2}):e;switch(r){case"success":default:return t.jsx(c,{size:12,stroke:s(),strokeWidth:3});case"error":return t.jsx(d,{size:12,stroke:s(),strokeWidth:3})}})()}),i]})};let p=o.div`
  display: flex;
  align-items: center;
