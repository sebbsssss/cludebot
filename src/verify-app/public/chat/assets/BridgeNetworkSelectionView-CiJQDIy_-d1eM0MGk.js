import{at as P,au as S,b3 as R,b7 as Q,r as z,j as e,b8 as C,b9 as E,ba as H,bb as O,bc as U,aV as o}from"./vendor-privy-fSo4QxTG.js";import{n as V}from"./getErc20Balance-o7J9W1su-BelqqFBp.js";import{k as Y,u as q}from"./ModalHeader-BnVmXtvG-DOrMIVst.js";import{c as D,s as G}from"./Layouts-BlFm53ED-B9ZXbQ4l.js";import{t as J}from"./FundWalletMethodHeader-Cb-ACySl-DrJX5c7X.js";import{s as $,e as f,n as K}from"./Value-tcJV9e0L-CybuSCkH.js";import{e as L}from"./ErrorMessage-D8VaAP5m-DwdVszT6.js";import{r as M}from"./Subtitle-CV-2yKE4-DrRkxpoo.js";import{e as W}from"./Title-BnzYV3Is-DBBPP5Tf.js";import{F as X}from"./WalletIcon-B83tCzm4.js";import{e as N}from"./getChainName-DjpPdUSc-c2urPd0g.js";import{n as Z}from"./Chip-D2-wZOHJ-DQwOeE6n.js";import{w as _}from"./TransferOrBridgeLoadingScreen-DVeIRghG-DhfLr4n_.js";import{d as ee,e as re}from"./shared-FM0rljBt-DE5BzcH3.js";import{F as ae}from"./ChevronDownIcon-C4u9ZYX8.js";import{t as k}from"./formatErc20TokenAmount-BuPk9xcy-CkAr4Oc0.js";import{c as F}from"./ethers-Dnv1tMN3-BEjAQ0Um.js";import{a as ne,p as se,s as ie,c as oe,l as te}from"./styles-DDaGxKdi-CBFg6FZ3.js";const Qe=({chains:s,appId:r,address:a,rpcConfig:t,includeUsdc:c})=>Promise.all(s.map((async n=>{let m=P({chain:n,transport:S(R(n,t,r))}),b=await m.getBalance({address:a}).catch((()=>0n)),i=null,l=Q[n.id];if(c&&l){let{balance:h}=await V({address:a,chain:n,rpcConfig:t,appId:r,erc20Address:l});i=h}return{balance:b,erc20Balance:i,erc20Address:l,chain:n}}))),ce=({balance:s,className:r,chain:a})=>e.jsx(ee,{className:r,$state:void 0,children:e.jsx(j,{balance:s,chain:a})}),j=({balance:s,chain:r})=>e.jsxs(e.Fragment,{children:[e.jsxs(le,{children:[e.jsx(me,{chainId:typeof r=="object"?r.id:"solana"}),e.jsx(K,{children:typeof r=="object"?r.name:N(r)})]}),e.jsxs(Z,{isLoading:!1,isPulsing:!1,color:"gray",children:[e.jsx(de,{children:e.jsx(X,{})}),s]})]});let le=o.div`
  display: flex;
  align-items: center;
`,de=o.div`
  height: 0.75rem;
