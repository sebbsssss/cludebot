...
export async function runExport(): Promise<void> {
  ...
  ${c.bold}Examples:${c.reset}
    ...
    ${c.cyan}npx clude-bot export --format chatgpt${c.reset}         For ChatGPT
    ${c.cyan}npx clude-bot export --format gemini${c.reset}          For Gemini Gems
    ${c.cyan}npx clude-bot export --format clipboard${c.reset}       Copy to clipboard
